...
<div class="container-fluid">
	...
	<div class="row justify-content-center align-items-center p-4" style="box-shadow: 3px 3px 12px rgba(0,0,0,0.8);border-radius: 5px;">
			...
			<spr:form action="withdrawAmt1.htm" method="post" commandName="accHolder" >
			<div class="form-row">
			<div class="form-group col-md-12">
      		<label for="withdrawAmount"><h4>Withdraw Amount:</h4></label>
      		<spr:input class="form-control" id="withdrawAmount" path="accBalance" />
    		</div>
			</div>
			
			<button type="submit" class="btn btn-dark mb-2">Withdraw</button>
			<a href="accTransaction.jsp" style="margin:8px;text-decoration: none;outline=none;color: black;font-size:25px;">back</a>
			</spr:form>
