...
<% AccountHolder ah = (AccountHolder)request.getAttribute("accHolder");
	...
	<tr>
		...
		<td>
		<h4><%= ah.getAccBalance() %></h4>
		</td>
	</tr>
	<tr>
	 <td>
	 	<a href="accTransaction.jsp" class="btn btn-primary btn-lg active" role="button" style="background-color:grey;border:none;width:150px; " aria-pressed="true">Done</a>
	 </td>
	</tr>
	</table>
